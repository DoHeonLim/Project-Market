...
import { getCachedPost, getUser, incrementPostViews } from "./actions/posts";
...
export default async function PostDetailPage({
  ...
  // 조회수 증가와 상세 캐시는 분리해서 병렬로 처리
  const [post] = await Promise.all([getCachedPost(id), incrementPostViews(id)]);
