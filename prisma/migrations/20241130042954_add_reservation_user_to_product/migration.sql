...
INSERT INTO "new_Product" ("created_at", "description", "id", "photo", "price", "purchase_date", "purchase_userId", "reservation_at", "title", "updated_at", "userId") SELECT "created_at", "description", "id", "photo", "price", "purchase_date", "purchase_userId", "reservation_at", "title", "updated_at", "userId" FROM "Product";
DROP TABLE "Product";
