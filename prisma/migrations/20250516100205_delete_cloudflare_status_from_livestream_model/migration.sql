/*
  ...
  - You are about to drop the column `cloudflare_status` on the `LiveStream` table. All the data in the column will be lost.
...
CREATE INDEX "LiveStream_ingest_protocol_idx" ON "LiveStream"("ingest_protocol");
CREATE INDEX "LiveStream_status_reason_idx" ON "LiveStream"("status_reason");
